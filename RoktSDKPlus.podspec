Pod::Spec.new do |s|
  ...
  s.description = <<-DESC
    ...
    (mParticle-Rokt 9.1+ with RoktContracts 2.x), and Rokt Payment Extension (Shoppable Ads).
  DESC
  s.homepage = 'https://github.com/ROKT/sdk-plus-ios'
  s.license = { :type => 'Apache 2.0', :file => 'LICENSE' }
  s.author = { 'ROKT' => 'nativeappsdev@rokt.com' }
  s.source = { :git => 'https://github.com/ROKT/sdk-plus-ios.git', :tag => 'v' + s.version.to_s }
  s.swift_version = '5.9'
  s.ios.deployment_target = '15.6'
  s.requires_arc = true
  s.source_files = 'Sources/RoktSDKPlus/**/*.swift'
  s.dependency 'mParticle-Apple-SDK', '~> 9.1'
  s.dependency 'mParticle-Rokt', '~> 9.1'
